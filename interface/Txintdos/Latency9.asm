...
Positive:
		...
		sub	cseg:PulseLength, 500	; waarde een beetje aanpassen
		ror	cseg:PulseLength, 1
		cmp	cseg:PulseLength, 10000
		ja	Sync
...
;		out	dx, al
		...
		byte	"Channel 9: %ld       \n"
		byte	"Channel10: %ld       \n\n",0
		dword	SyncPulse, Ch1, Ch2, Ch3, Ch4, Ch5, Ch6, Ch7, Ch8, Ch9, Ch10
