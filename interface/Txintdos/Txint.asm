...
; This is only necessary when generating ints with the data lines...
; We are using a data line e.g line 9 to output 5V directly to line 10
; Note: 0V will generate the interrupt since we've got nACK (i.e. ACK generates ints when low)
...
;		out	dx, al
		...
		printf
		byte	"                     Blacksphere DOS Utilities (C) 2000\n\n"
		byte	" Sync Pulse: %ld          \n\n",0
		dword	SyncPulse
