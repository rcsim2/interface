...
{ 
	...
	tie.pszText = "Fourth";    TabCtrl_InsertItem(pHdr->hwndTab, 3, &tie);
    
	// Lock the resources for the four child dialog boxes. 
	...
	pHdr->apRes[3] = DoLockDlgRes(MAKEINTRESOURCE(IDD_PROPPAGE4));
    ...
    SetWindowPos(pHdr->hwndTab, NULL, rcTab.left+5, rcTab.top+5, 
            rcTab.right - rcTab.left-150, rcTab.bottom - rcTab.top-10, 
            SWP_NOZORDER);
/*	
...
*/	
	...
	SetWindowPos(hwndDlg, NULL, 0, 0, 
        ...
        2 * GetSystemMetrics(SM_CYDLGFRAME) + GetSystemMetrics(SM_CYCAPTION))-420,
