...
/*
FARPROC wpOrigComboBoxProc;

// Subclass procedure
LRESULT APIENTRY ComboBoxSubclassProc( HWND hwnd, UINT uMsg, WPARAM wParam, LPARAM lParam) 
{ 
    if (uMsg == WM_GETDLGCODE) 
        return DLGC_WANTALLKEYS;

    return CallWindowProc(wpOrigComboBoxProc, hwnd, uMsg, wParam, lParam); 
}
*/
...
BOOL CALLBACK Tab3DlgProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
	...
	switch(uMsg)
	{
		case WM_INITDIALOG:
			...
			SendMessage( GetDlgItem(hWnd, IDC_COMBO1), CB_ADDSTRING, 0, (LPARAM)(LPCSTR)"Pitch");
			SendMessage( GetDlgItem(hWnd, IDC_COMBO1), CB_ADDSTRING, 0, (LPARAM)(LPCSTR)"Roll");
			SendMessage( GetDlgItem(hWnd, IDC_COMBO1), CB_ADDSTRING, 0, (LPARAM)(LPCSTR)"Nick");
			SendMessage( GetDlgItem(hWnd, IDC_COMBO1), CB_ADDSTRING, 0, (LPARAM)(LPCSTR)"Tail");
			SendMessage( GetDlgItem(hWnd, IDC_COMBO1), CB_ADDSTRING, 0, (LPARAM)(LPCSTR)"Throttle");
			SendMessage( GetDlgItem(hWnd, IDC_COMBO1), CB_ADDSTRING, 0, (LPARAM)(LPCSTR)"Function6");
			SendMessage( GetDlgItem(hWnd, IDC_COMBO1), CB_ADDSTRING, 0, (LPARAM)(LPCSTR)"Function7");
			SendMessage( GetDlgItem(hWnd, IDC_COMBO1), CB_ADDSTRING, 0, (LPARAM)(LPCSTR)"Function8");
			SendMessage( GetDlgItem(hWnd, IDC_COMBO1), CB_ADDSTRING, 0, (LPARAM)(LPCSTR)"Function9");
			SendMessage( GetDlgItem(hWnd, IDC_COMBO1), CB_ADDSTRING, 0, (LPARAM)(LPCSTR)"Function10");
			SendMessage( GetDlgItem(hWnd, IDC_COMBO1), CB_ADDSTRING, 0, (LPARAM)(LPCSTR)"Function11");
			SendMessage( GetDlgItem(hWnd, IDC_COMBO1), CB_ADDSTRING, 0, (LPARAM)(LPCSTR)"Function12");
            ...
            //wpOrigComboBoxProc = (FARPROC) SetWindowLong( GetDlgItem(hWnd, IDC_COMBO1), 
            //    GWL_WNDPROC, (LONG) ComboBoxSubclassProc );
...
/*
		...
		sprintf( pulselength,  "%.3f ms", fpulselength );
		
		//static int test=0;
		//++test;
		//sprintf( pulselength,  "%d", test );
