...
BOOL CALLBACK Tab1DlgProc(HWND hWnd, UINT uMsg, WPARAM wParam, LPARAM lParam)
{
  switch(uMsg)
  {
	  ...
	  case WM_CTLCOLORSTATIC:
		  SetTextColor( GetDC(GetDlgItem(hWnd,IDC_STATICSTATUS)), COLOUR_RED);
		  break;
...
void GameLoop()
{
	...
	//TextOut( GetDC(GetDlgItem(g_hTabCurrent,IDC_STATICSTATUS)), 0, 0, status, 128 );
	...
	// draw the bars (1000-2000 uS becomes 0-100 percent)
	DrawBar( GetDlgItem(g_hTabCurrent,IDC_PROGRESSHORZ1), int((RetInfo[1]-1000)/10) );
	DrawBar( GetDlgItem(g_hTabCurrent,IDC_PROGRESSHORZ2), int((RetInfo[2]-1000)/10) );
	DrawBar( GetDlgItem(g_hTabCurrent,IDC_PROGRESSHORZ3), int((RetInfo[3]-1000)/10) );
	DrawBar( GetDlgItem(g_hTabCurrent,IDC_PROGRESSHORZ4), int((RetInfo[4]-1000)/10) );
	DrawBar( GetDlgItem(g_hTabCurrent,IDC_PROGRESSHORZ5), int((RetInfo[5]-1000)/10) );
	DrawBar( GetDlgItem(g_hTabCurrent,IDC_PROGRESSHORZ6), int((RetInfo[6]-1000)/10) );
	DrawBar( GetDlgItem(g_hTabCurrent,IDC_PROGRESSHORZ7), int((RetInfo[7]-1000)/10) );
	DrawBar( GetDlgItem(g_hTabCurrent,IDC_PROGRESSHORZ8), int((RetInfo[8]-1000)/10) );
	DrawBar( GetDlgItem(g_hTabCurrent,IDC_PROGRESSHORZ9), int((RetInfo[9]-1000)/10) );
	DrawBar( GetDlgItem(g_hTabCurrent,IDC_PROGRESSHORZ10), int((RetInfo[10]-1000)/10) );
...
void DrawBar(HWND hwnd,int percent)
{
#define COLOUR_TEXT		RGB(0,0,0)
#define COLOUR_BAR		RGB(255,255,255)
